...
class ModeloUsuario
{
    ...
    static public function mdlRegistroUsuario($datos)
    {
        ...
        if (empty($errores)) {
            ...
            $hashedPass = password_hash($datos['pass'], PASSWORD_DEFAULT);
            ...
            $registro->bindParam(":pass", $hashedPass, PDO::PARAM_STR);
    ...
    static public function mdlLogin($datos)
    {
        ...
        if (empty($email)) {
            ...
            // Siempre devolver un array con 'success' para consistencia
